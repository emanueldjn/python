# O desafio é desenvolver um programa que simule o saque de dinheiro em um caixa eletrônico, garantindo que o valor seja válido e utilizando a menor quantidade possível de cédulas disponíveis.
